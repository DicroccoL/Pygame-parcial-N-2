...
def activar_doble_chance(datos_juego: dict) -> None:
    """
    Activa el comodín 'doble chance'.
    """
    datos_juego["comodines_usados"]["doble_chance"] = True
    datos_juego["doble_chance_activado"] = True
    datos_juego["intento_doble"] = False

def usar_pasar_pregunta(datos_juego: dict) -> None:
    """
    Activa el comodín 'pasar', que permite saltear una pregunta sin penalización.
    """
    datos_juego["comodines_usados"]["pasar"] = True
    datos_juego["pasar_activado"] = True